...
const stats = [
  { label: 'Startups', value: '127+' },
  { label: 'MRR Tracked', value: '$45M+' },
  { label: 'Investors', value: '2,400+' },
  { label: 'On-Chain Reports', value: '15K+' },
];
...
const steps = [
  ...
  { icon: 'M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12', title: 'Publish', desc: 'Publish metrics on-chain with proof hashes' },
  { icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', title: 'Verify', desc: 'Chainlink oracles verify your data' },
  { icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6', title: 'Grow', desc: 'Investors discover and trust verified startups' },
];

const features = [
  { icon: 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z', title: 'On-Chain Proof', desc: 'Every metric is recorded on Base with an immutable proof hash. No more black-box reporting.' },
  { icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', title: 'Oracle Verification', desc: 'Chainlink oracles cross-check your data against real-world sources for authenticity.' },
  { icon: 'M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z', title: 'Soulbound Badges', desc: 'Earn non-transferable reputation badges based on your verified track record.' },
  { icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4', title: 'DAO Governance', desc: 'Token holders govern the protocol. Vote on fee structures, categories, and ecosystem grants.' },
  { icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4', title: 'Staking Tiers', desc: 'Stake CMT tokens to unlock premium analytics, API access, and real-time alerts.' },
  { icon: 'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064', title: 'Carbon Tracking', desc: 'Track and verify your startup\'s carbon offset data alongside financial metrics.' },
];
    ...
    <div className="overflow-hidden">
      ...
      <section className="relative flex min-h-[80vh] items-center justify-center px-4 py-24">
        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          >
            ChainMetrics brings radical transparency to startup fundraising. Publish your metrics on Base blockchain, get verified by oracles, and build investor trust.
          </motion.p>
          <motion.div
